...
function AddyUrlSettingFactory(e) { function s(e) { e = e.replace(/[\[\]]/g, "\\$&"); var s = new RegExp("[?&]" + e + "(=([^&#]*)|&|#|$)").exec(t); return s ? s[2] ? decodeURIComponent(s[2].replace(/\+/g, " ")) : "" : null } this.createOptions = function () { var e = {}; return e.ignoreKeys = [38, 40, 13], e.excludePostBox = s("excludePostBox") || !1, e.nzCountryValue = s("nzCountryValue") || "NZL", e }, this.createConfig = function () { var e = {}; return e.key = s("key"), e.key && "" != e.key || console.warn("The API key is missing"), e.maxItems = s("maxItems") || 10, e.debounceMs = s("debounceMs") || 250, e }, this.createCallback = function () { var e = s("callback"); return e && "function" == typeof window[e] ? e : null }; var t = function () { var s = document.getElementsByTagName("script"); e = e.toLowerCase(); for (var t = 0; t < s.length; t++) if (s[t].src && -1 !== s[t].src.toLowerCase().indexOf(e)) return s[t].src; return console.warn("Script source not found. Name: ", e), "" }() } function AddyComplete(e, s) { function t(e) { a.fields.address && (a.fields.address.value = e.displayline), a.fields.suburb && (a.fields.suburb.value = e.suburb), a.fields.city && (a.fields.city.value = e.city), a.fields.region && (a.fields.region.value = e.region), a.fields.postcode && (a.fields.postcode.value = e.postcode), a.fields.line1 && (a.fields.line1.value = e.address1), a.fields.line2 && (a.fields.line2.value = e.address2), a.fields.line3 && (a.fields.line3.value = e.address3), a.fields.line4 && (a.fields.line4.value = e.address4), a.fields.address1 && a.fields.address2 && (e.address4 || 0 === e.address2.indexOf("RD ") ? (a.fields.address1.value = e.address1, a.fields.address2.value = e.address2) : (a.fields.address1.value = e.displayline, a.fields.address2.value = "")) } function n(e, s) { var t = new XMLHttpRequest; t.open("GET", e, !0), t.onload = function () { var e = JSON.parse(t.responseText); s(e) }, t.setRequestHeader("addy-api-key", i.key), t.send() } if (e) { var a = this; a.urlBase = "https://www.addy.co.nz/", a.fields = s || {}, a.options = addySettingsFactory.createOptions(); var i = addySettingsFactory.createConfig(); a.awesomplete = new Awesomplete(e, { maxItems: i.maxItems, minChars: 3, autoFirst: !0, sort: !1 }), a.awesomplete.filter = function () { return !0 }, e.onkeyup = function (e, s) { var t; return function () { var n = this, a = arguments; clearTimeout(t), (t = setTimeout(function () { t = null, e.apply(n, a) }, s)) || e.apply(n, a) } }(function (e) { -1 !== a.options.ignoreKeys.indexOf(e.keyCode) || this.value.length < a.awesomplete.minChars || (a.fields.country && this.fields.country.options[a.fields.country.selectedIndex].value !== a.options.nzCountryValue ? a.awesomplete.list = [] : n(a.urlBase + "api/search?expostbox=" + a.options.excludePostBox + "&max=" + a.awesomplete.maxItems + "&s=" + this.value, function (e) { a.awesomplete.list = e.addresses.map(function (e) { return { label: e.a, value: e.id } }) })) }, i.debounceMs), e.addEventListener("awesomplete-selectcomplete", function (e) { n(a.urlBase + "api/address/" + e.text.value, function (e) { t(e) }) }, !1) } else console.warn("Input field is missing") } var addySettingsFactory = new AddyUrlSettingFactory("addycomplete"), addyInitCallback = addySettingsFactory.createCallback(); addyInitCallback && window[addyInitCallback]();
